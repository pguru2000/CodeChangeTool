...
from utils import department_xlsmanager as xlsutil
...
def index(request):
    return render(request, 'generate_department/index.html')
...
def startconvert(request):
    ...
    success = xlsutil.concatStart(UPLOAD_PATH + excelfile, concat_1, concat_2)
